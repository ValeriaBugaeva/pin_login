...
@endsection
@include('company/todo/todo-sidebar')
@section('content')
<style>
#errorMessage {
    color: red;
...
{{-- <a href="#" id="save" class="btn btn-primary pull-right" onclick="saveindexing();">Save Order</a>
 --}}
...
@section('page-script')
  <!-- Page js files -->
  <script src="{{ asset(mix('js/scripts/pages/app-todo.js')) }}?time=<?php echo time(); ?>"></script>
