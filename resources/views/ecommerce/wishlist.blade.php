...
<section id="wishlist" class="grid-view wishlist-items">
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <div class="item-name">
        <a href="{{url('ecommerce/details')}}">Apple Watch Series 5</a>
      </div>
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <div class="item-name">
        <a href="{{url('ecommerce/details')}}">Apple iPhone 11 (64GB, Black)</a>
      </div>
      <p class="card-text item-description">
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <div class="item-name">
        <a href="{{url('ecommerce/details')}}">Apple iMac 27-inch</a>
      </div>
      <p class="card-text item-description">
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <div class="item-name">
        <a href="{{url('ecommerce/details')}}">OneOdio A71 Wired Headphones</a>
      </div>
      <p class="card-text item-description">
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <div class="item-name">
        <a href="{{url('ecommerce/details')}}">Apple - MacBook Air® (Latest Model) - 13.3" Display - Silver</a>
      </div>
      <p class="card-text item-description">
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <div class="item-name">
        <a href="{{url('ecommerce/details')}}">Switch Pro Controller </a>
      </div>
      <p class="card-text item-description">
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <div class="item-name">
        <a href="{{url('ecommerce/details')}}">Google - Google Home - White/Slate fabric </a>
      </div>
      <p class="card-text item-description">
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <div class="item-name">
        <a href="{{url('ecommerce/details')}}">Sony 4K Ultra HD LED TV </a>
      </div>
      <p class="card-text item-description">
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <div class="item-name">
        <a href="{{url('ecommerce/details')}}">OnePlus 7 Pro </a>
      </div>
      <p class="card-text item-description">
