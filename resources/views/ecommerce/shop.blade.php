...
@endsection
@include('ecommerce/ecommerce-sidebar')
@section('content')
...
<section id="ecommerce-products" class="grid-view">
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="{{url('ecommerce/details')}}">Apple Watch Series 5</a>
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="{{url('ecommerce/details')}}">Apple iPhone 11 (64GB, Black)</a>
        <span class="card-text item-company">By <a href="javascript:void(0)" class="company-name">Apple</a></span>
      </h6>
      <p class="card-text item-description">
  ...
  <div class="card ecommerce-card">
    <div class="item-img text-center">
      <a href="{{url('ecommerce/details')}}"><img class="img-fluid card-img-top" src="{{ asset('images/pages/eCommerce/3.png') }}" alt="img-placeholder" /></a>
    </div>
    <div class="card-body">
      <div class="item-wrapper">
        <div class="item-rating">
      ...
      <h6 class="item-name">
        <a class="text-body" href="{{url('ecommerce/details')}}">Apple iMac 27-inch</a>
        <span class="card-text item-company">By <a href="javascript:void(0)" class="company-name">Apple</a></span>
      </h6>
      <p class="card-text item-description">
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="{{url('ecommerce/details')}}">OneOdio A71 Wired Headphones</a>
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="{{url('ecommerce/details')}}">
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="{{url('ecommerce/details')}}"> Switch Pro Controller </a>
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="{{url('ecommerce/details')}}"> Google - Google Home - White/Slate fabric </a>
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="{{url('ecommerce/details')}}"> Sony 4K Ultra HD LED TV </a>
        <span class="card-text item-company">By <a href="javascript:void(0)" class="company-name">Apple</a></span>
      </h6>
      <p class="card-text item-description">
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="{{url('ecommerce/details')}}"> OnePlus 7 Pro </a>
