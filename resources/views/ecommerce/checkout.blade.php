      ...
      <div id="place-order" class="list-view product-checkout">
        ...
        <div class="checkout-items">
          <div class="card ecommerce-card">
            ...
            <div class="card-body">
              <div class="item-name">
                <h6 class="mb-0"><a href="{{url('ecommerce/details')}}" class="text-body">Apple Watch Series 5</a></h6>
          ...
          <div class="card ecommerce-card">
            ...
            <div class="card-body">
              <div class="item-name">
                <h6 class="mb-0">
                  <a href="{{url('ecommerce/details')}}" class="text-body">Apple iPhone 11 (64GB, Black)</a>
                </h6>
                <span class="item-company">By <a href="javascript:void(0)" class="company-name">Apple</a></span>
                <div class="item-rating">
                  <ul class="unstyled-list list-inline">
          ...
          <div class="card ecommerce-card">
            ...
            <div class="card-body">
              <div class="item-name">
                <h6 class="mb-0"><a href="{{url('ecommerce/details')}}" class="text-body">Apple iMac 27-inch</a></h6>
                <span class="item-company">By <a href="javascript:void(0)" class="company-name">Apple</a></span>
                <div class="item-rating">
                  <ul class="unstyled-list list-inline">
                    <li class="ratings-list-item"><i data-feather="star" class="filled-star"></i></li>
          ...
          <div class="card ecommerce-card">
            ...
            <div class="card-body">
              <div class="item-name">
                <h6 class="mb-0">
                  <a href="{{url('ecommerce/details')}}" class="text-body">OneOdio A71 Wired Headphones</a>
                </h6>
          ...
          <div class="card ecommerce-card">
            ...
            <div class="card-body">
              <div class="item-name">
                <h6 class="mb-0">
                  <a href="{{url('ecommerce/details')}}" class="text-body"
          ...
          <div class="card ecommerce-card">
            ...
            <div class="card-body">
              <div class="item-name">
                <h6 class="mb-0">
                  <a href="{{url('ecommerce/details')}}" class="text-body">Switch Pro Controller </a>
                </h6>
