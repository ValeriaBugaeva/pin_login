...
<html lang="fr" data-textdirection="ltr" class="dark-layout">
...
<link rel="stylesheet" href="http://167.99.250.153/vendors/css/ui/prism.min.css" />
  ...
  <!-- vendor css files -->
  <link rel="stylesheet" href="http://167.99.250.153/vendors/css/extensions/sweetalert2.min.css">
...
<link rel="stylesheet" href="http://167.99.250.153/css/base/plugins/extensions/ext-component-sweet-alerts.css">
      ...
      <div class="bookmark-wrapper d-flex align-items-center">
        <ul class="nav navbar-nav">
          <li class="nav-item">
            ...
            <div class="msg-date">21/04/2021 - 11:24</div>
            </a>
          </li>
        </ul>
      </div>
...
<div class="text-center mb-3 d-xl-none d-lg-none">
  <h1 class="display-5">Confirmation</h1>
  <div class="card">
    <img class="card-img-top" src="http://167.99.250.153/images/slider/04.jpg" alt="Card image cap" />
  </div>
          ...
          <form class="form">
            <div class="row">
              <div class="col-md-6 col-lg-4">
                ...
                <label for="disabledInput">Arrival date</label>
                <input
                  type="text"
                  class="form-control"
                  id="readonlyInput"
              ...
              <div class="col-md-6 col-lg-4">
                <div class="form-group">
                <label for="disabledInput">Arrival hour</label>
                <input
                  type="text"
                  class="form-control"
                  id="readonlyInput"
              ...
              <div class="col-md-6 col-lg-4">
                <div class="form-group">
                <label for="disabledInput">Arrival Place</label>
                <input
                  type="text"
                  class="form-control"
                  id="readonlyInput"
              ...
              <div class="col-12">
                <button type="reset" class="btn btn-primary mr-1" id="position-top-end">Confirm</button>
                <button type="reset" class="btn btn-outline-secondary" id="confirm-color">Back</button>
              </div>
            </div>
          </form>
        </div>
...
<script src="http://167.99.250.153/vendors/js/ui/prism.min.js"></script>
  <!-- vendor files -->
  <script src="http://167.99.250.153/vendors/js/extensions/sweetalert2.all.min.js"></script>
...
<script src="http://167.99.250.153/js/scripts/customizer.js"></script>
  ...
  <!-- Page js files -->
  <script src="http://167.99.250.153/js/scripts/extensions/ext-component-sweet-alerts.js"></script>
