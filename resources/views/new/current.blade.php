      ...
      <div class="bookmark-wrapper d-flex align-items-center">
        <ul class="nav navbar-nav">
          <li class="nav-item">
            ...
            <div class="msg-date">21/04/2021 - 11:31</div>
            </a>
          </li>
        </ul>
      </div>
...
<div class="text-center mb-3 d-xl-none d-lg-none">
  ...
  <h1 class="display-6">11:31</h1>
</div>
<div class="text-center mb-3 d-xl-none d-lg-none">
  <h1 class="display-7">Hours Worked</h1>
  <h1 class="display-2">11:31</h1>
  <br/>
</div>
<!-- for mobile device -->
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12 mb-1 mb-lg-0">
            <button type="button" class="btn btn-warning btn-block btn-lg">
              <i data-feather="pause" class="mr-25"></i>
              <span>Take a Break</span>
            </button>
          </div>
          <div class="col-lg-6 col-md-12">
            <button type="button" class="btn btn-danger btn-block btn-lg">
              <i data-feather="log-out" class="mr-25"></i>
              <span>End Shift</span>
            </button>
          </div>
        </div>
...
<div class="text-center mb-3 d-none d-lg-block">
  <h3>Break Duration</h3>
  <h1 class="display-4">11:31</h1>
  </div>
  <div class="text-center mb-3 d-none d-lg-block">
  <h1 class="display-4">Hours Worked</h1>
  <h1 class="display-1">11:31</h1>
  </div>
</div>
<!-- for desktop and tablet device -->
