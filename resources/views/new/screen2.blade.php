    ...
    <div class="container" style="text-align: center;">
        ...
        <form action="/screen3" method="POST">
            ...
            <div class="container card"
                style="height: 10rem; margin-left: auto; margin-right: auto; margin-top: 2rem; padding: 20px; text-align: left;">
                <div class="row">
                    <div class="col">
                    ...
                    <div class="col" style="text-align: right;">
                        <p> {{ $arrival['date'] }} </p>
                        <input type="hidden" name="date" value="{{ $arrival['date'] }}" />
                    </div>
                </div>
                <hr>
                ...
                <div class="row">
                    ...
                    <div class="col" style="text-align: right;">
                        <p> {{ $arrival['time'] }} </p>
                        <input type="hidden" name="time" value="{{ $arrival['time'] }}" />
                    </div>
                </div>
            </div>
            <div style="margin-left: auto; margin-right: auto; margin-top: 2rem;">
                <a href="/screen1" type="button" class="btn btn-light" style="width: 7.5rem; color: grey;">
                    <strong> Back </strong> </a>

                <button class="btn btn-primary" type="submit"
                    style="width: 7.5rem; color: white; background-color: #7f56ac; border-color: #7f56ac;"> <strong>
