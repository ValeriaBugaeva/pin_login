<body class="vertical-layout vertical-menu-modern {{ $configData['showMenu'] === true ? '2-columns' : '1-column' }} {{
    ...
    }} {{ $configData['bodyClass'] }}  {{ $configData['theme'] === 'light' ? '' : $configData['layoutTheme'] }} {{
  ...
  {{-- Include Sidebar --}}
  @if((isset($configData['showMenu']) && $configData['showMenu'] === true)) @include('staff.panels.sidebar') @endif

  {{-- Include Navbar --}}
  @include('staff.panels.navbar')
  ...
  @if($configData['blankPage'] == false) @include('content/pages/customizer') @include('content/pages/support') @endif
