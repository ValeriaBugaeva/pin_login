      ...
      <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        ...
        @csrf
          <div class="form-group">
            ...
            <input class="form-control @error('email') is-invalid @enderror" id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" aria-describedby="email" autofocus="" tabindex="1" />
