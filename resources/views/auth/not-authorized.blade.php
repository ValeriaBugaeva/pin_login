...
@endphp
@extends('staff/layout/fullLayoutMaster')
...
<div class="misc-wrapper">
  <a class="brand-logo" href="javascript:void(0);">
    ...
    <h2 class="brand-text text-primary ml-1">Staff</h2>
  </a>
  <div class="misc-inner p-2 p-sm-3">
    <div class="w-100 text-center">
      ...
      <a class="btn btn-primary mb-1 btn-sm-block" href="{{url('staff/login')}}">Back to login</a>
