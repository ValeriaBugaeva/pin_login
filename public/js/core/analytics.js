    ...
    function X(a, b, c) {
        if (c && c.action) {
            ...
            if ("get" === d) {
                ...
                "post" === d &&
                    ((a = V(a, b, c.action)), x.test(a) && (c.action = a));
        }
    }
    var ba = function (a) {
            try {
    ...
    var hc = !1,
        mc = function (a) {
            if ("cookie" == P(a, ac)) {
                ...
                a.get(je) &&
                    (c = P(a, Se)) &&
                    ((g = Math.min(R(a, bf), 1e3 * R(a, Zb))),
                    (g = Math.min(
                        g,
                        1e3 * R(a, Te) + g - new Date().getTime()
                    )),
                    a.data.set(bf, g),
                    (b = {}),
                    (e = P(a, Te)),
    ...
    var td = function (a, b) {
            ...
            if (a.get(Hd)) {
                ...
                if (b || !a.get(Je)) g = !1;
                    ...
                    ((g = a.get(F)), void 0 === g || g("analytics_storage"))
                )
                    g = !1;
                else {
                    J(84);
                ...
                if (/^(https?|android-app):\/\//i.test(l)) {
                    ...
                    if (!de(l, g)) {
                        if (
                            ca &&
                            ((ca =
                                g.replace(/\./g, "-") + ".cdn.ampproject.org"),
                            de(l, ca))
                        ) {
                            l = void 0;
                            break a;
