        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="' +
              commonPath + full['id'] +
              '" data-toggle="tooltip" data-placement="top" title="Add Permissions">' +
              feather.icons['shield'].toSvg({ class: 'font-medium-2' }) +
              '</a>' +
              '<a Onclick="editStaffDetails('+full['id']+')" href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Edit">' +
              feather.icons['edit'].toSvg({ class: 'font-medium-2' }) +
              '</a>' +
              '<a href="javascript:;" onClick=removestaff(' + full['id'] + ');"  data-toggle="tooltip" data-placement="top" title="Delete">' +
