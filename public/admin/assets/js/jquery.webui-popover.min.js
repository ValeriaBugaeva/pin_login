...
!(function (a, b, c) {
  ...
  function d(b, c) {
    (this.$element = a(b)),
      c &&
        ("string" === a.type(c.delay) || "number" === a.type(c.delay)) &&
        (c.delay = {
          show: c.delay,
          hide: c.delay,
        }),
  ...
  var e = "webuiPopover",
    ...
    h = {
      ...
      animation: null,
      template:
        '<div class="webui-popover"><div class="arrow"></div><div class="webui-popover-inner"><a href="#" class="close">x</a><h3 class="webui-popover-title"></h3><div class="webui-popover-content"><i class="icon-refresh"></i> <p>&nbsp;</p></div></div></div>',
      backdrop: !1,
      dismissible: !0,
      onShow: null,
      onHide: null,
  ...
  (d.prototype = {
    init: function () {
      "click" === this.getTrigger()
        ? this.$element
            .off("click touchend")
            .on("click touchend", a.proxy(this.toggle, this))
    ...
    displayContent: function () {
      ...
      this.$element.trigger(k, [d]),
        "auto" !== this.options.width && d.width(this.options.width),
        "auto" !== this.options.height && e.height(this.options.height),
        this.options.style &&
          this.$target.addClass(f + "-" + this.options.style),
        ...
        this.options.padding ||
          ("auto" !== this.options.height && e.css("height", e.outerHeight()),
          this.$target.addClass("webui-no-padding")),
        (h = d[0].offsetWidth),
        (i = d[0].offsetHeight);
      var l = this.getTargetPositin(b, j, h, i);
      if (
        (this.$target.css(l.position).addClass(j).addClass("in"),
      ...
      if (
        ...
        o.removeAttr("style"),
          l.arrowOffset &&
            (-1 === l.arrowOffset.left || -1 === l.arrowOffset.top
              ? o.hide()
              : o.css(l.arrowOffset));
      }
    ...
    getTarget: function () {
      if (!this.$target) {
        ...
        (this.$target = a(this.options.template)
          .attr("id", b)
          .data("trigger-element", this.getTriggerElement())),
          (this._customTargetClass =
            this.$target.attr("class") !== f
    ...
    getContentElement: function () {
      return (
        this.$contentElement ||
          ((this.$contentElement = this.getTarget().find("." + f + "-content")),
    ...
    getOffsetLeft: function () {
      return (
        o(this.$element.attr("data-offset-left")) || this.options.offsetLeft
      );
    },
    getCache: function () {
    ...
    getContent: function () {
      if (this.getUrl())
        switch (this.options.type) {
          case "iframe":
            this.content = a('<iframe frameborder="0"></iframe>').attr(
              "src",
              this.getUrl()
            );
            break;
        ...
        var c = "";
        if (
          ((c = a.isFunction(this.options.content)
            ? this.options.content.apply(this.$element[0], [this])
            : this.options.content),
          (this.content = this.$element.attr("data-content") || c),
          !this.content)
        ) {
    ...
    setContent: function (a) {
      ...
      "string" == typeof a
        ? c.html(a)
        : a instanceof jQuery &&
          (a.removeClass(f + "-content"), c.html(""), a.appendTo(c)),
        (this.$target = b);
    },
    isAsync: function () {
      ...
      this.xhr ||
        (this.xhr = a.ajax({
          ...
          success: function (d) {
            c.bindBodyEvents(),
              (c.content =
                b && a.isFunction(b) ? b.apply(c.$element[0], [d]) : d),
    ...
    bindBodyEvents: function () {
      this.options.dismissible &&
        ...
        (n
          ...
          .on("keyup.webui-popover", a.proxy(this.escapeHandler, this)),
        n
          .off("click.webui-popover touchend.webui-popover")
          .on(
            "click.webui-popover touchend.webui-popover",
            a.proxy(this.bodyClickHandler, this)
          ));
    },
    ...
    initTargetEvents: function () {
      "hover" === this.getTrigger() &&
        ...
        this.$target
          .find(".close")
          .off("click")
          .on("click", a.proxy(this.hide, this, !0)),
        this.$target
          .off("click.webui-popover")
          .on("click.webui-popover", a.proxy(this.targetClickHandler, this));
    },
        ...
        n
          ? (b =
              f / 3 > j
                ...
                : "top-left")
          : "auto-top" === b
          ? (b = f / 3 > j ? "top-right" : (2 * f) / 3 > j ? "top" : "top-left")
          : "auto-bottom" === b
          ? (b =
              f / 3 > j
                ? "bottom-right"
          ...
          : "auto-left" === b
          ? (b =
              g / 3 > k ? "left-top" : (2 * g) / 3 > k ? "left" : "left-bottom")
          : "auto-right" === b &&
            (b =
              g / 3 > k
                ? "right-top"
      ...
      var f = [],
        g = this.each(function () {
          ...
          g
            ? "destroy" === b
              ? g.destroy()
              : "string" == typeof b && f.push(g[b]())
            : (b
                ? "string" == typeof b
                  ? "destroy" !== b &&
                    (c || ((g = new d(this, null)), f.push(g[b]())))
                  : "object" == typeof b && (g = new d(this, b))
                : (g = new d(this, null)),
              a.data(this, "plugin_" + e, g));
        });
      return f.length ? f : g;
    });
